    ...
    return (
        <Card>
            <CardHeader className="flex flex-col items-stretch space-y-0 border-b p-0 sm:flex-row">
                ...
                <div className="flex">
                    {['loan', 'return_book'].map((key, index) => {
                        return (
                            <button
                                key={index}
                                data-active={activeChart === key}
                                className="even:border-1 sm:py6 relative z-30 flex flex-1 flex-col justify-center gap-1 border-t px-6 py-4 text-left data-[active=true]:bg-muted/50 sm:border-t-0 sm:px-8"
            ...
            <CardContent className="px-2 sm:p-6">
                <ChartContainer config={chartConfig} className="aspect-auto h-[250px] w-full">
                    ...
                    >
                        ...
                        <Bar dataKey={activeChart} fill={`val(--color-${activeChart})`} />
                    </BarChart>
                </ChartContainer>
            </CardContent>
        </Card>
