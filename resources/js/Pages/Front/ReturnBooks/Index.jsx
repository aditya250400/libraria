                ...
                <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-3">
                    <CardStat
                        data={{
                            title: 'Dikembalikan',
                            icon: IconCreditCardRefund,
                            background: 'text-white bg-gradient-to-r from-green-400 via-green-600 to-green-500',
                    ...
                    <CardStat
                        data={{
                            title: 'Pengecekan',
                            icon: IconChecklist,
                            background: 'text-white bg-gradient-to-r from-blue-400 via-blue-600 to-blue-500',
                            iconClassName: 'text-white',
                        }}
                    >
                    ...
                    <CardStat
                        data={{
                            title: 'Denda',
                            icon: IconMoneybag,
                            background: 'text-white bg-gradient-to-r from-red-400 via-red-600 to-red-500',
                            iconClassName: 'text-white',
                        }}
                    >
