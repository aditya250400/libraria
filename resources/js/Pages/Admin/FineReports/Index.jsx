    ...
    return (
        <>
            <div className="flex w-full flex-col space-y-4 pb-32">
                ...
                <h2 className="font-semibold leading-relaxed text-foreground">Tabel Rincian Denda</h2>
                <Card className="">
                    <CardHeader>
                    ...
                    <CardFooter>
                        <p className="mb-2 text-sm text-muted-foreground">
                            ...
                            <span className="font-meidum text-blue-500">
                                {meta.to ?? 0} dari {meta.total} denda
                            </span>
                        </p>
                ...
                <div className="grid gap-4 md:gap-8 lg:grid-cols-2">
                    ...
                    <div className="grid gap-4 lg:grid-cols-1">
                        <CardStatDescription title="Sudah Dibayar" description="Denda yang sudah berhasil dibayar">
                            <div className="flex items-baseline gap-2 text-3xl font-bold tabular-nums leading-none text-blue-500">
                                {formatToRupiah(props.page_data.fine_paid)}
                            </div>
                        </CardStatDescription>
                        <CardStatDescription title="Belum Dibayar" description="Denda yang belum dibayar">
                            <div className="flex items-baseline gap-2 text-3xl font-bold tabular-nums leading-none text-blue-500">
