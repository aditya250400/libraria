                        ...
                        <div>
                            <p className="mt-2 text-sm text-foreground">
                                ...
                                <Link
                                    ...
                                    method="post"
                                    as="button"
                                    className="text-sm underline rounded-md text-muted-foreground hover:text-foreground focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                                >
